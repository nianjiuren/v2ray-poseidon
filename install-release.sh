...
# Original source is located at github.com/nianjiuren/v2ray-poseidon/blob/master/install-release.sh
...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/nianjiuren/v2ray-poseidon/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/nianjiuren/v2ray-poseidon/releases/latest"
